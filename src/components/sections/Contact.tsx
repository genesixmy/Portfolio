  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key:
            process.env.NEXT_PUBLIC_WEB3FORMS_KEY || '2c7d6601-ab76-4511-adc5-b152dfa099b8',
          name: formState.name,
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-lg text-dark-400 max-w-2xl mx-auto">
            Ada projek dalam fikiran? Saya sentiasa terbuka untuk berbincang tentang projek baru dan
            peluang kerjasama.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          >
            <div>
              <h3 className="text-2xl font-display font-bold text-white mb-4">Get in Touch</h3>
              <p className="text-dark-400">
                Saya excited untuk mendengar tentang projek anda. Jangan segan untuk reach out!
              </p>
            </div>
            ...
            {/* Social Links */}
            <div className="pt-4">
              <p className="text-sm text-dark-500 mb-4">Follow me</p>
            ...
            <form onSubmit={handleSubmit} className="glass-card !p-8">
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <option value="Collaboration" className="bg-dark-900">
                    Collaboration
                  </option>
                  <option value="Question" className="bg-dark-900">
                    Question
                  </option>
