      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-lg text-dark-400 max-w-2xl mx-auto">
            ...
            from pixel-perfect interfaces to complex backend systems.
          </p>
        </motion.div>
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="flex gap-4 animate-marquee">
              {[...technologies, ...technologies].map((tech, index) => (
                <div
                  key={`${tech.name}-${index}`}
                  className="flex-shrink-0 px-6 py-3 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 transition-colors"
                >
                  <span className="text-sm font-medium text-dark-200">{tech.name}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          {[
            ...
            },
            {
              ...
              title: "3D & Animation",
              description: "Immersive 3D experiences and captivating motion graphics.",
            },
            {
