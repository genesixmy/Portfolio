...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.936-4.02 4.395-6.87zm-6.115 7.808c-.153-.9-.75-4.032-2.19-7.77l-.066.02c-5.79 2.015-7.86 6.025-8.04 6.4 1.73 1.358 3.92 2.166 6.29 2.166 1.42 0 2.77-.29 4-.814zm-11.62-2.58c.232-.4 3.045-5.055 8.332-6.765.135-.045.27-.084.405-.12-.26-.585-.54-1.167-.832-1.74C7.17 11.775 2.206 11.71 1.756 11.7l-.004.312c0 2.633.998 5.037 2.634 6.855zm-2.42-8.955c.46.008 4.683.026 9.477-1.248-1.698-3.018-3.53-5.558-3.8-5.928-2.868 1.35-5.01 3.99-5.676 7.17zm7.567-7.79c.286.38 2.16 2.91 3.835 6.02 3.652-1.37 5.203-3.45 5.347-3.654-1.782-1.58-4.13-2.544-6.7-2.544-.84 0-1.665.096-2.462.27zm7.012 4.086c-.193.26-1.92 2.474-5.735 4.038.228.475.444.96.645 1.446.07.17.136.338.2.506 3.407-.43 6.79.264 7.124.332-.02-2.383-.85-4.57-2.234-6.32z" />
      </svg>
    ),
  },
];
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            with stunning design. Specializing in interactive web applications, 3D
            experiences, and brand identity systems.
          </motion.p>
